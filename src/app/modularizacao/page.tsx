        ...
        <ContainerDiv>
          <ContainerSM aniDirecao={-100}>
            ...
            <CArticle>
              <ol className="list-disc ps-5 text-start">
                ...
                <li>
                  <strong>Manutenção facilitada:</strong> corrigir ou melhorar
                  só um módulo, sem mexer no resto.
                </li>
                <li>
                  <strong>Trabalho em equipe:</strong> cada pessoa pode
                  trabalhar em um módulo diferente.
                </li>
                <li>
          ...
          <ContainerSM aniDirecao={100}>
            ...
            <CArticle>
              <ol className="list-disc ps-5 text-start">
                <li>
                  <strong>Exige mais arquivos:</strong> Isso pode ser um
                  problema para projetos pequenos.
                </li>
                <li>
                  <strong>
